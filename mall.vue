<template>
  ...
  <el-col :span="6"><div class="grid-content bg-purple"></div></el-col>
        ...
        <el-table :data="adCates" style="width: 100%" border>
            ...
            <el-table-column prop="name" label="商品名" width=""/>
            <el-table-column prop="width" label="首字母" width="" />
            <el-table-column prop="height" label="品牌制造" width="" />
             <el-table-column prop="name" label="状态" width=""/>
            <el-table-column prop="width" label="产品数量" width="" />
            <el-table-column prop="height" label="产品评论数量" width="" />
    ...
    <el-dialog v-model="dialogFormVisible" title="用户信息编辑">
        <el-form :model="adCate">
            ...
            <el-form-item label="品牌制作" :label-width="formLabelWidth">
                <el-input v-model="adCate.height" autocomplete="off" />
            </el-form-item>
